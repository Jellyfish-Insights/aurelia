...
namespace WebApp.Controllers {
    public class DBContentDataBackend : AbstractDBDataBackend, IContentDataBackend {
        ...
        private static MetricType[] SourceVideoMetrics =
            new MetricType[] { MetricType.Views, MetricType.Likes, MetricType.Dislikes, MetricType.Shares, MetricType.Comments, MetricType.ViewTime, MetricType.Reactions, MetricType.SubscribersGained, MetricType.SubscribersLost };
...
//.Where(m => metrics.Contains(m.Type)).ToList()
                        ...
                        new Metric() {
                            ...
                            Value = x.Sum(y => y.SubscribersGained) ?? 0
                        }, new Metric() {
                            Type = "Subscribers Lost",
                            Value = x.Sum(y => y.SubscribersLost) ?? 0
                        }
                    }
                };
