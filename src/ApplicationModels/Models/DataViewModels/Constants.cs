...
"
            ...
            #endif
            new MetricInfo {
                TypeId = MetricType.SubscribersGained,
...
**YouTube:** The number of times that users subscribed to a channel. See [subscribersGained](https://developers.google.com/youtube/analytics/metrics#subscribersGained).
"
            },
            new MetricInfo {
                TypeId = MetricType.SubscribersLost,
                Type = "Subscribers Lost",
                Unit = "",
                UnitSide = "left",
                ChartType = ChartType.LINE,
                PageType = "content",
...
**YouTube:** The number of times that users unsubscribed from a channel. See [subscribersLost](https://developers.google.com/youtube/analytics/metrics#subscribersLost).
"
            },
        };
